  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-blue-200 rounded-full opacity-30 animate-pulse delay-300"></div>
        <div className="absolute bottom-40 left-20 w-20 h-20 bg-purple-200 rounded-full opacity-25 animate-pulse delay-700"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-teal-100 rounded-full opacity-15 animate-pulse delay-1000"></div>
        ...
        <div className="absolute top-60 right-1/3 animate-bounce delay-1000">
          <Star className="h-5 w-5 text-teal-400 opacity-50" />
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 p-8 md:p-12 text-center mb-8">
            ...
            <div className="relative mb-8">
              <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-teal-500 to-blue-500 rounded-full shadow-xl animate-bounce">
            ...
            <div className="mb-8">
              ...
              {/* Next Steps Card */}
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-2xl p-6 border border-teal-100 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <a 
                ...
                className="flex items-center justify-center space-x-3 bg-blue-500 hover:bg-blue-600 text-white px-6 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                ...
                className="flex items-center justify-center space-x-3 bg-teal-500 hover:bg-teal-600 text-white px-6 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/"
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-teal-600 to-blue-600 text-white font-semibold rounded-full hover:from-teal-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
              ...
              <Link 
                to="/services"
                className="inline-flex items-center px-8 py-3 border-2 border-teal-600 text-teal-600 font-semibold rounded-full hover:bg-teal-600 hover:text-white transition-all duration-300 transform hover:scale-105"
              >
                Explore Services
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold text-teal-600 mb-2">HSR Layout Clinic</h3>
                <img 
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold text-blue-600 mb-2">Banashankari Clinic</h3>
                <img 
